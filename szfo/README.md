# Данные для округа: Северо-Западный федеральный округ (szfo)

## Сгенерированная база данных:

- **Файл:** `output/stores_szfo.db`
- **Сетей:** 11 974
- **Локаций:** 173 608
- **Размер:** 45.45 MB
...
- Конфигурация округа: `cities/szfo.json`
- Для генерации базы: `node generate-cities.js szfo`