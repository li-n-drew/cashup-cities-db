# Данные для округа: Приволжский федеральный округ (pfo)

## Сгенерированная база данных:

- **Файл:** `output/stores_pfo.db`
- **Сетей:** 5 486
- **Локаций:** 76 289
- **Размер:** 19.85 MB
...
- Конфигурация округа: `cities/pfo.json`
- Для генерации базы: `node generate-cities.js pfo`