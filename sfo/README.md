# Данные для округа: Сибирский федеральный округ (sfo)

## Сгенерированная база данных:

- **Файл:** `output/stores_sfo.db`
- **Сетей:** 3 694
- **Локаций:** 44 293
- **Размер:** 11.67 MB
...
- Конфигурация округа: `cities/sfo.json`
- Для генерации базы: `node generate-cities.js sfo`