# Данные для округа: Южный федеральный округ (ufo)

## Сгенерированная база данных:

- **Файл:** `output/stores_ufo.db`
- **Сетей:** 5 264
- **Локаций:** 66 931
- **Размер:** 17.67 MB
...
- Конфигурация округа: `cities/ufo.json`
- Для генерации базы: `node generate-cities.js ufo`