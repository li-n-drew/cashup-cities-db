# Данные для округа: Центральный федеральный округ (cfo)

## Сгенерированная база данных:

- **Файл:** `output/stores_cfo.db`
- **Сетей:** 7 986
- **Локаций:** 115 824
- **Размер:** 30.21 MB
...
- Конфигурация округа: `cities/cfo.json`
- Для генерации базы: `node generate-cities.js cfo`