# Данные для округа: Уральский федеральный округ (urfo)

## Сгенерированная база данных:

- **Файл:** `output/stores_urfo.db`
- **Сетей:** 3 900
- **Локаций:** 48 553
- **Размер:** 12.68 MB
...
- Конфигурация округа: `cities/urfo.json`
- Для генерации базы: `node generate-cities.js urfo`